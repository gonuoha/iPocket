...
const CHAOS_ICONS: ChaosIcon[] = [
  ...
  {
    id: "browser",
    color: SYSTEM_ITEM_TYPE_COLORS.snippet,
    icon: (
  ...
  {
    id: "terminal",
    color: SYSTEM_ITEM_TYPE_COLORS.command,
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-5">
  ...
  {
    id: "file",
    color: SYSTEM_ITEM_TYPE_COLORS.file,
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-5">
  ...
  {
    id: "bookmark",
    color: SYSTEM_ITEM_TYPE_COLORS.prompt,
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="size-5">
    ...
    >
      {CHAOS_ICONS.map((icon, index) => (
        <div
          ...
          style={icon.color ? { color: adaptTypeColor(icon.color) } : undefined}
        >
          {icon.icon}
        </div>
      ))}
